...
void CStartUpState::init()
{
    ...
    m_upSpriteWaffles.reset( new CSprite( CObjectDataMgr::Instance().getData2D( "(startup)", "bk" ) ) );
    m_upSpriteLogo.reset( new CSprite( CObjectDataMgr::Instance().getData2D( "(startup)", "scaled_frame2" ) ) );
